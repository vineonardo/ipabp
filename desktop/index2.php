						...
						<div class="uk-grid-collapse" uk-grid>
							<div class="uk-width-2-3">
								<div class="p-10">
									...
									<div class="uk-text-muted uk-text-small pt-10">Sponsored</div>	
								</div>
							</div>
							<div class="uk-width-1-3">
					...
					<div class="uk-width-1-3">
						<div  class="uk-grid-small" uk-grid>
							<div class="uk-width-1-2">
								<div class="news_featured">
									<a href="#"><img class="uk-border-remove" src="images/new.jpg" width="100%"></a>
									<div class="news_content">
			...
			<div class="uk-grid-small uk-margin-top" uk-grid>
				<div class="uk-width-1-4">
					<div class="news_featured" style="box-shadow: none;border:1px solid #999;">
						<a href="#"><img class="uk-border-remove" src="images/mov_rev.png" width="100%"></a>
