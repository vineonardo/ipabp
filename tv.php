    ...
    <div id="content">
        ...
        <div class="section uk-padding-small">
            <div class="uk-flex section-header uk-flex-between">
                <h2 class="section-heading red-label">लाइव टीवी</h2>
            </div>

            <div class="live-video uk-card uk-card-default uk-margin-small uk-overflow-hidden">
                <div class="uk-position-relative uk-overflow-hidden uk-border-rounded-top">
                    <img data-src="https://img.etimg.com/thumb/width-640,height-360,imgsize-225294,resizemode-1,msid-72074484/government-mulls-raising-insurance-cover-on-bank-deposits-to-above-rs-1-lakh-nirmala-sitharaman.jpg" alt="Featured Article" width="400" height="250" uk-img/>
                    <span class="play-icon uk-position-center" uk-icon="icon:triangle-right;ratio:1.5"></span>
                </div>

                <div class="uk-grid uk-child-width-expand">
                    <div>
                        <div class="uk-padding-small">
                            <span class="live-label live-large uk-margin-remove"> Watching Live</span>    
                        </div>
                    </div>
                    <div class="uk-background-muted uk-flex uk-flex-start">
                        <button class="switch">Switch to ABP Ganga <span uk-icon="triangle-down"></span></button>
                        <div uk-dropdown>
        ...
        <div class="uk-position-relative" uk-slider>
            <div class="uk-flex section-header uk-flex-between">
                <h3 class="section-heading red-label">डोंट मिस</h3>    
        ...
        <div class="section video-slider uk-background-muted for-you uk-padding-small">
        <div class="uk-position-relative" uk-slider>
            <div class="uk-flex section-header uk-flex-between">
                <h3 class="section-heading red-label">आपके लिए</h3>    
                <a href="#" class="view-all"><span>View All</span><span class="icon"></span></a>
            </div>
